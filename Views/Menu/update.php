<h1>Bienvenido al update menu..!</h1>
<form action='Controllers/menu_controller.php' method='post'>
	<input type='hidden' name='action' value='update'>
    <div class="form-floating mb-3">
      <input type="hidden" class="form-control" id="IdMenu" name="IdMenu" value="<?php echo $menu->IdMenu; ?>">
    </div>
    <div class="form-floating mb-3">
      <input type="text" class="form-control" id="floatingInput" placeholder="Ingrese" name="NameMenu" required value="<?php echo $menu->NameMenu; ?>">
