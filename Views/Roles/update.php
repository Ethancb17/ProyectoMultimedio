<h1>Bienvenido al update rol..!</h1>
<form action='Controllers/roles_controller.php' method='post'>
	<input type='hidden' name='action' value='update'>
    <div class="form-floating mb-3">
      <input type="hidden" class="form-control" id="IdRol" name="IdRol" value="<?php echo $rol->IdRol; ?>">
    </div>
    <div class="form-floating mb-3">
      <input type="text" class="form-control" id="floatingInput" placeholder="Ingrese" name="NameRol" required value="<?php echo $rol->NameRol; ?>">
